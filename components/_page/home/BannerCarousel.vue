      ...
      <div class="container">
        <div class="client-swiper-info">
          ...
          <div class="client-swiper-wrapper">
            <div
              @click="slideMove(-1)"
              class="swiper-btn swiper-btn-left flex h-10 w-10 cursor-pointer items-center justify-center rounded-[50%] bg-white/80"
            >
              <span class="i i-carousel-left"></span>
            </div>
            <div
              @click="slideMove(1)"
              class="swiper-btn swiper-btn-right flex h-10 w-10 cursor-pointer items-center justify-center rounded-[50%] bg-white/80"
            >
